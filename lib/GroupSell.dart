...
class GroupSell extends StatefulWidget{
  const GroupSell({Key key}) : super(key: key);
  @override
  _GroupSellState createState() => _GroupSellState();
}
class _GroupSellState extends State<GroupSell> {
